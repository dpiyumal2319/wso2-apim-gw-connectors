...
public class AzureFederatedApiKeyConnector implements FederatedApiKeyConnector {
    ...
    private static final String PROPERTY_API_NAME = "api.name";
    ...
    public FederatedApiKeyCreationResult createApiKey(String apiReferenceArtifact, String apiKeyUuid,
        ...
        try {
            ...
            String displayName = generateDisplayName(apiKeyName, properties);
    ...
    public FederatedApiKeyCreationResult replaceApiKey(String apiReferenceArtifact, String apiKeyUuid,
        ...
        try {
            ...
            String subscriptionName = StringUtils.defaultIfBlank(resolveSubscriptionName(apiKeyReferenceArtifact),
                    generateSubscriptionName(apiKeyUuid));
            String displayName = generateDisplayName(null, properties);
    ...
    public void applyRateLimitPolicy(String apiReferenceArtifact, String apiKeyReferenceArtifact, String localPolicyId,
        ...
        if (log.isDebugEnabled()) {
            log.debug("Skipping rate-limit policy association for Azure API-bound key. keyRef="
                    + apiKeyReferenceArtifact);
        }
    }
    ...
    public void removeRateLimitPolicy(String apiReferenceArtifact, String apiKeyReferenceArtifact,
        ...
        if (log.isDebugEnabled()) {
            log.debug("Skipping rate-limit policy dissociation for Azure API-bound key. keyRef="
                    + apiKeyReferenceArtifact);
        }
    }
     ...
     */
    private String generateSubscriptionName(String keyUuid) {
     ...
     */
    private String generateDisplayName(String apiKeyName, Map<String, String> properties) {
        String apiName = getProperty(properties, PROPERTY_API_NAME);
